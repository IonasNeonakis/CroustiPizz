...
namespace CroustiPizz.Mobile.Extensions
{
    public abstract class EventBehavior<TView, TBehavior> : BehaviorBase<TView> where TView : BindableObject
    {
        public static readonly BindableProperty CommandProperty =
            BindableProperty.CreateAttached("Command", typeof(ICommand), typeof(TBehavior), null);

        public static readonly BindableProperty CommandParameterProperty =
            BindableProperty.CreateAttached("CommandParameter", typeof(object), typeof(TBehavior), null);
